...
- **The shortfall figures.** Hesper's "a hundred and forty pints short" in Chapter 8 was cut; the shortfall is now expressed as the standing schedule for four hundred people over nine days, which is consistent with the meter over-reading by about a third to forty per cent. Marda Senn's slate now gives the ward's real draw as **two and three-quarter times** the standing schedule against the account's four times, so the arithmetic in Chapter 6 closes.

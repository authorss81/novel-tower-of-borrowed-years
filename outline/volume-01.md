# Volume 01 Outline — The Unpaid Ward

Volume number: 1
Chapter range: 1–50
Civic period: **MR 412–413**, flood season and the first public audit
Batch map: 0001 (1–10), 0002 (11–20), 0003 (21–30), 0004 (31–40), 0005 (41–50)

Central pressure: Nine days of rain bring the Silt up against Bell Weir. Tallow Ward — kitchens, tanneries, fuel yards, and the city's manual labor — is short of water at the flood peak, and the only way to keep the low kitchens supplied before the peak is to seal a ward settlement that draws future recovery from eleven named households. Marek's brother Tomas's own vigor loan posts its remaining draw in the same week, and the ward's bill is payable only from a reserve line that does not exist. Marek must certify a file he can no longer trust, and the price of stopping it lands on a junior clerk who never met him.

Starting state: The tower is trusted because it works. A clerk's job is to make files clean, and a clean file is treated as a solved problem. Tallow Ward pledges labor and future work more often than years of life, which makes it the easiest district to bill and the hardest district to organize. The Yearspire Trust holds the emergency authority to declare a settlement; the Chamber of Accounts has the paper and almost none of the power.

Starting relationships:

- **Marek ↔ Tomas:** protective, embarrassed, unresolved. Marek believes a reasonable accounting solution exists; Tomas believes the ledger is the thing that made the danger legible after the fact.
- **Marek ↔ Tamsin:** loving and unquestioned, and therefore unasked anything. Tamsin is a named witness on Tomas's loan and knows more about the mark on Marek's wrist than she says.
- **Marek ↔ Hesper Rann:** grateful, and Hesper's favorite clerk. Hesper has kept clinics open and buried mistakes. Marek has never needed to choose between them before.
- **Marek ↔ Neris Kade:** not yet met. Volume 1 opens them as opposing witnesses, ending in respect without liking.
- **Marek ↔ Sera Holt:** distant mentor. Sera trains him in what a body pays and is herself hiding the clinic's own loan.
- **Marek ↔ Ilya Senn:** an unfamiliar name on a work order and a man who has been keeping the ward alive against orders.
- **Marek ↔ Ondra Kelb:** new. A junior counter-clerk in his third week who trusts Marek because Marek answers questions.
...
- **The Tally Halls, Bell Stair** — copy room, receipt desks, the posting board, the public register, the Tally Stair.
- **The Threshold, Stillstep Island** — intake windows, petitions, the public complaint board, across the causeway from the city.
- **Tallow Ward** — four shared water yards, fuel yards, tanneries, low kitchens at the Tallow Gate, the Third Sluice.
- **The Season Vaults** — sealed stores; the case holding the oldest reference volume, whose first page is blank and signed **A-0**.
- **The Morrowfen clinic** — where year scars are read on bodies.
- **The Hollow Galleries** — where removed records live; entered once, in Chapter 22, and not understood.
- **Rainmarket and Crown Terrace** — the yard that the ward's water is billed to, and the district that does not drink from it.

Major factions and forces in this volume: the **Chamber of Accounts** (tired, hierarchical, must publish dissent and has never done so), the **Yearspire Trust** through one man — **Renata Vole**, Deputy Settlement Steward, who answers upward and treats an appeal as a scheduling problem — the **Lantern Wardens** under Ilya Senn, Tallow Ward's water-yard captain **Aldis Kern** and his yard crews, the ward's households, and one arriving regional official, **Councilor Bel Harrow**. No lender, no market, no Compact, no Choir, no military enters this volume. Hesper Rann is its only criminal.

### New Volume 01 names (locked)

- **Ondra Kelb**, 20, junior counter-clerk in the Chamber, three weeks in the post. Countersigned Hesper's falsified water entry in good faith. Injured by the volume's Boundary Hold. Lives, recovers slowly, is not written to forgive quickly.
- **Renata Vole**, 57, Deputy Settlement Steward, Yearspire Trust. Signs emergency settlements, opposes appeals as a delay to the water.
- **Aldis Kern**, 44, Tallow Ward water-yard captain. Four yards, about four hundred people. Honest, unheroic, and the ward's public voice.
- **Bohdan Rezek**, 51, fuel-yard foreman. The first visible victim of the ward settlement; the man whose hands give out in the copy room.
- **Nadja Ostrow**, 38, kitchen cook, one of the eleven named households on the levy.
- **Marda Senn**, Ilya's sister, a Warden's ledger clerk who keeps her own pump counts. Her name leaves the warden's roll in Chapter 22 and does not come back in this volume.
- **Bel Harrow**, Crown March representative, arrives in Chapter 31 and chairs the emergency appeals board.

### New Volume 01 local terms (locked)

- **the Silt** — the river through the basin.
- **Bell Weir** — the upstream weir, at its limit through the whole volume.
- **the Tallow Gate** — the ward's floodgate at the low kitchens; the boundary named in the ward file.
- **the Third Sluice** — the settlement valve Ilya Senn holds open against a Crown Terrace order.
- **the posting** — the announced settlement date, put on the Threshold board.
- **the levy** — a ward's standing repayment obligation, distinct from a single loan's pledge.
...
- The falsified entry is struck and published with its correction, not quietly replaced.
...
Next-volume question: The Trust's order to re-copy the oldest register requires borrowing the reference volume, and the volume's first line is a blank with a signature on it that clerks are taught never to erase. Marek now knows that an invented reserve can be written against a line nobody can read, which means the line can be drawn against by anyone. Who owns the missing year at the head of every ledger, what authority does **A-0** claim over the archive, and what happens when someone starts selling claims against a blank?

Final chapter image: In the copy room on the last evening of the rains, Marek copies the first page of the oldest register into the public register by hand, because the Trust's order said the page would be replaced. He writes the blank line and leaves it blank rather than inventing a value, and beneath it he writes the signature, in full, as a clerk is taught to do when the seal is not his to break. Tallow's yards are running on the public levy and the lamps are lit along the Tallow Gate. Lio asks him whose year the empty one is. He tells her the only true thing he has: that somebody has to write down what the tower owes, and that he does not know yet, and that the line is not going to be closed while he is the clerk of record. The copy goes into the public register, where anyone may read it. The Trust's notice stays nailed to the Tally Hall door, unsigned by anyone who will admit to reading it.

## Chapter Map (50 chapters)

### Movement I — Rain on the Ledger (1–10)
...
11. The clinic: what a body pays, what is already gone, and the only question left being whose.
12. The ward at dawn: real gratitude for the held settlement and real hatred for the junior clerk the clerks are blaming.
...
20. Hesper's second certification, which makes Kelb's countersignature the whole of the case. He now knows what the file is.
...
25. Marek confronts Hesper with the arithmetic; Hesper names the four people who would have died. The midpoint turns.
26. A second night of high water; the ward divides; Kern gives evidence against Ilya.
...
38. Hesper corners Marek with Tomas's loan and Lio's name, and for the first time is simply cruel.
39. Hesper files the aimed certification naming Kelb as a careless operator; a junior clerk's name is destroyed in public.
40. The board is forced into session for a date and the settlement is postponed to the hearing.

### Movement V — The Unpaid Ward (41–50)
...
- The resolution saves the season and changes one institution. It does not make the tower safe, and it does not erase the old debt.
